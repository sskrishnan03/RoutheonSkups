...
class User(db.Model, UserMixin):
    ...
    preferences = db.Column(db.JSON, nullable=True) # {"categories": [], "budget": "medium", ...}
...
class Notification(db.Model):
    ...
    type = db.Column(db.String(50), default='info') # info, success, warning, trip
...
class DestinationActivity(db.Model):
    ...
    created_at = db.Column(db.DateTime, default=datetime.utcnow)
    user = db.relationship('User', backref='destination_activities', lazy=True)
